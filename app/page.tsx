  ...
  const projects = [
    {
      ...
      period: "2024",
      description: "Led frontend team in developing a comprehensive client portal for contract management and data processing",
      tech: ["React.js", "TypeScript", "Material-UI", "Vite"],
    },
    {
      title: "AI Resume Parser",
      period: "2024",
      description: "Worked as senior Developer on Intelligent UI for AI-driven resume parsing and job matching",
